package FundamentalsModule.Lists.MoreExcercises;
...
public class MixedUpLists {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> firstline = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed().collect(Collectors.toCollection(ArrayList::new));

        ArrayList<Integer> secondline = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed().collect(Collectors.toCollection(ArrayList::new));
