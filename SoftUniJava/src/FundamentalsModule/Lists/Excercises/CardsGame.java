package FundamentalsModule.Lists.Excercises;
...
public class CardsGame {
    public static void main(String[] args) {
        ...
        List<Integer> arrei = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed()
                .collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
        List<Integer> arrei2 = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed()
                .collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
        int biggerplayer = 0;
